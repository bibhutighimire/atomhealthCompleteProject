...
namespace AtomHealth.Migrations
{
    ...
    [Migration("20210106054609_changesthree")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AtomHealth.Models.ApplicationUser", b =>
                {
                    ...
                    b.Property<string>("HeightMeasure")
                        .HasColumnType("varchar(10)");
            ...
            modelBuilder.Entity("AtomHealth.Models.Dateofbirth", b =>
                {
            ...
            modelBuilder.Entity("AtomHealth.Models.Lifestyle", b =>
                {
            ...
            modelBuilder.Entity("AtomHealth.Models.MedicalRecord", b =>
                {
            ...
            modelBuilder.Entity("AtomHealth.Models.ApplicationUser", b =>
                {
                    b.HasOne("AtomHealth.Areas.Identity.Data.AtomHealthUser", "AtomHealthUser")
                        ...
                        .HasForeignKey("AtomHealth.Models.ApplicationUser", "AtomHealthUserID");
            ...
            modelBuilder.Entity("AtomHealth.Models.Dateofbirth", b =>
                {
                    b.HasOne("AtomHealth.Areas.Identity.Data.AtomHealthUser", "AtomHealthUser")
                        .WithOne("Dateofbirth")
                        .HasForeignKey("AtomHealth.Models.Dateofbirth", "AtomHealthUserID");
            ...
            modelBuilder.Entity("AtomHealth.Models.Lifestyle", b =>
                {
                    b.HasOne("AtomHealth.Areas.Identity.Data.AtomHealthUser", "AtomHealthUser")
                        .WithOne("Lifestyle")
                        .HasForeignKey("AtomHealth.Models.Lifestyle", "AtomHealthUserID");
            ...
            modelBuilder.Entity("AtomHealth.Models.MedicalRecord", b =>
                {
                    b.HasOne("AtomHealth.Areas.Identity.Data.AtomHealthUser", "AtomHealthUser")
                        ...
                        .HasForeignKey("AtomHealth.Models.MedicalRecord", "AtomHealthUserID");
            ...
            modelBuilder.Entity("AtomHealth.Models.QRCode", b =>
                {
                    ...
                    b.HasOne("AtomHealth.Areas.Identity.Data.AtomHealthUser", "AtomHealthUser")
                        .WithOne("QRCode")
                        .HasForeignKey("AtomHealth.Models.QRCode", "AtomHealthUserID");
